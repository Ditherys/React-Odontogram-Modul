...
- **مخطط الأسنان:** ملف تشريح الأسنان (`classic` الافتراضي / `measured`) — يعرض `measured` تسعة قوالب أسنان مقاسة وفق الأدبيات في تخطيط بقوسين وعرض لكل سن؛ قابل للتبديل أثناء التشغيل، دون تأثير على الافتراضي `classic`
...
React Advanced Odontogram من إنشاء وصيانة Zoltan Dul ([@ZoliQua](https://github.com/ZoliQua))، وهو مبتكر المحرك بأكمله ومطوّره الرئيسي. بمساعدة قيّمة من المساهمين المذكورين أدناه. شكرًا لكل من ساهم.
