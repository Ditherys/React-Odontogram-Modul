...
- **Одонтограмма:** профиль анатомии зубов (`classic` по умолчанию / `measured`) — `measured` отображает девять шаблонов зубов, измеренных по литературе, в двухдуговой раскладке с индивидуальной шириной зуба; переключается во время работы, не влияет на значение по умолчанию `classic`
